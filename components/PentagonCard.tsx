...
const PentagonCard: React.FC<PentagonCardProps> = ({ game, onClick, onHover, isHovered }) => {
  return (
    <div 
    ...
    >
      {/* Clip container */}
      <div className="absolute inset-0 clip-pentagon bg-white overflow-hidden transition-colors duration-300">
      ...
      {/* Decorative Border Ring (simulated via drop shadow in parent, but we can add an SVG overlay if needed for stroke) */}
      <div 
        className="absolute inset-0 clip-pentagon border-4 border-transparent pointer-events-none"
